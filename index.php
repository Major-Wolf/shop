                ...
                <div class="col-lg-7 d-none d-lg-block">
                    <div class="site-navigation">
                        <ul class="main-menu nav">
                            ...
                            <li class="has-submenu"><a href="shop.html">Каталог</a>
                                <!-- <ul class="sub-menu">
                        ...
                        <div class="col-lg-6">
                            <div class="slide-content">
                                <div class="slide-content-inner">
                                    <h3>НОВЫЕ ТЕХНОЛОГИИ УЖЕ В НАЛИЧИИ</h3>
                                    <h2>КУПИ &amp; НАСЛАЖДАЙСЯ <br> УСПЕВАЙ</h2>
                                    <a class="btn btn-white" href="shop.html">К покупкам</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container container-wide h-100">
                    <div class="row align-items-center h-100">
                        <div class="col-12">
                            <div class="slide-content">
                                <div class="slide-content-inner">
                                    <h3>НОВЫЕ ТИПЫ ТОВАРОВ</h3>
                                    <h2>АНИМЕ &amp; СУПЕРГЕРОИ <br> КОСПЛЕЙ И НЕ ТОЛЬКО</h2>
                                        <a class="btn btn-white" href="shop.html">К покупкам</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container container-wide">
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="banner-item">
                        <div class="banner-item__img">
                            <a href="#"><img src="assets/img/banner/banner-1.png" alt="Banner" /></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="banner-item">
                        <div class="banner-item__img">
                            <a href="#"><img src="assets/img/banner/banner-2.png" alt="Banner" /></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="banner-item">
                        <div class="banner-item__img">
                            <a href="#"><img src="assets/img/banner/banner-3.png" alt="Banner" /></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4 col-lg-4">
                    <div class="call-to-action-item mt-0">
                        ...
                        <div class="call-to-action-item__info">
                            <h3>Разные способы доставки</h3>
                            <p>Доставка от 49 рублей по всей России</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-lg-4">
                    <div class="call-to-action-item">
                        ...
                        <div class="call-to-action-item__info">
                            ...
                            <p>Мы не маркетплейс. Нам важно качество товара</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-lg-4">
                    <div class="call-to-action-item">
                        ...
                        <div class="call-to-action-item__info">
                            ...
                            <p>Мы всегда рады ответить вам на вопросы в чате</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-5 m-auto text-center">
                    <div class="section-title">
                        <h2 class="h3">Популярное сегодня</h2>
                        <p>Самые популярные товары в нашем магазине</p>
                    </div>
                </div>
            </div>
